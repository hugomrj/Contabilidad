...
function CabeceraFC_disabled ( ){

    document.getElementById( 'numero_factura').disabled = true;
    document.getElementById( 'facvenf_fecha_factura').disabled = true;
...
function CabeceraFC_json ( id ){
    ...
    {        
        ...
        document.getElementById('facvenf_fecha_factura').value = VJson( json, "fecha_factura", "D");
