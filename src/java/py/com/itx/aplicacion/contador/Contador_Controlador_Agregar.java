...
@WebServlet(name = "Contador_Controlador_Agregar",
        urlPatterns = {"/Contador/Controlador/Agregar"})


public class Contador_Controlador_Agregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            instancia = (Contador) persistencia.insert(instancia);
