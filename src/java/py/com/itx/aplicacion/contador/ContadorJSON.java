...
@WebServlet(name = "ContadorJSON", 
        urlPatterns = {"/Contador/Linea.json"})


public class ContadorJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
            ...
            if ( request.getParameter("id") != null) 
            {
                ...
                instancia = (Contador) persistencia.filtrarId(instancia, codigo);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ContadorJSON.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
