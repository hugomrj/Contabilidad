...
@WebServlet(name = "Contador_Controlador_Borrar",
        urlPatterns = {"/Contador/Controlador/Borrar"})


public class Contador_Controlador_Borrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            {
                Integer id = 0;
                id = Integer.parseInt(request.getParameter("contador") );
                
                Contador  instancia = new Contador();            
                Persistencia persistencia = new Persistencia();
                instancia = (Contador) persistencia.filtrarId(instancia ,id);
                instancia =  (Contador) persistencia.delete(instancia);
