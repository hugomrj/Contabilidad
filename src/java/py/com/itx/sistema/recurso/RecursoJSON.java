...
@WebServlet(name = "RecursoJSON", 
        urlPatterns = {"/Recurso/Linea.json"})


public class RecursoJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
            ...
            if ( request.getParameter("id") != null) 
            {
                ...
                instancia = (Recurso) persistencia.filtrarId(instancia, codigo);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RecursoJSON.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
