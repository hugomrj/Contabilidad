...
@WebServlet(name = "RolInteraccionJSON", 
        urlPatterns = {"/RolInteraccion/Linea.json"})


public class RolInteraccionJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
            ...
            if ( request.getParameter("id") != null) 
            {
                ...
                RolInteraccion instancia = new RolInteraccion();               
                Persistencia persistencia = new Persistencia();
                instancia = (RolInteraccion) persistencia.filtrarId(instancia, codigo);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RolInteraccionJSON.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
