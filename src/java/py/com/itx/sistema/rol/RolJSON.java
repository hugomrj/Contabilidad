...
@WebServlet(name = "RolJSON", 
        urlPatterns = {"/Rol/Linea.json"})


public class RolJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
            ...
            if ( request.getParameter("id") != null) 
            {
                ...
                instancia = (Rol) persistencia.filtrarId(instancia, codigo);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RolJSON.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
