...
@WebServlet(name = "Cliente_Controlador_Borrar",
        urlPatterns = {"/Cliente/Controlador/Borrar"})



public class Cliente_Controlador_Borrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            if ( request.getParameter("cliente") != null) 
            {
                ...
                instancia = (Cliente) persistencia.filtrarId(instancia ,id);
                ...
                instancia =  (Cliente) persistencia.delete(instancia);
