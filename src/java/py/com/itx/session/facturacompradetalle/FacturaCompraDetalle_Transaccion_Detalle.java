...
@WebServlet(name = "FacturaCompraDetalle_Transaccion_Detalle", 
        urlPatterns = {"/FacturaCompraDetalle/Transaccion/Detalle"})


public class FacturaCompraDetalle_Transaccion_Detalle extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
            ...
            for (Map<String, Object> map : rows) {
                   instancia = (FacturaCompraDetalle) persistencia.extraerRegistro(map, instancia);                   
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FacturaCompraDetalle_Transaccion_Detalle.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
