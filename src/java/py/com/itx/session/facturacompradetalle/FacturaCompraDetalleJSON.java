...
@WebServlet(name = "FacturaCompraDetalleJSON", 
        urlPatterns = {"/FacturaCompraDetalle/Linea.json"})


public class FacturaCompraDetalleJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {            
            ...
            {                
                ...
                instancia = (FacturaCompraDetalle) persistencia.filtrarId(instancia, codigo);

                
                // controlar si contador es igual al codigo de session       
                if (instancia.getFactura().getContador() != null){
                    if (!(contador.getContador() == instancia.getFactura().getContador().getContador())){
                        out.println("error403");  
                        return;                                    
                    }                
                }else{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FacturaCompraDetalleJSON.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
