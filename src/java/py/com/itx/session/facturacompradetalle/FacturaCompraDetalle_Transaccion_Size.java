...
@WebServlet(name = "FacturaCompraDetalle_Transaccion_Size",
        urlPatterns = {"/FacturaCompraDetalle/Transaccion/Size"})


public class FacturaCompraDetalle_Transaccion_Size extends HttpServlet {
...
*/
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FacturaCompraDetalle_Transaccion_Size.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
