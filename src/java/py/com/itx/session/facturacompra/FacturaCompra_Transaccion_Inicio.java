...
@WebServlet(name = "FacturaCompra_Transaccion_Inicio",
        urlPatterns = {"/FacturaCompra/Transaccion/Inicio"})


public class FacturaCompra_Transaccion_Inicio extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FacturaCompra_Transaccion_Inicio.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
