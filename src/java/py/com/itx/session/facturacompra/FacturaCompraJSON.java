...
@WebServlet(name = "FacturaCompraJSON", 
        urlPatterns = {"/FacturaCompra/Linea.json"})


public class FacturaCompraJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
            ...
            if ( ( request.getParameter("id") != null)  && (contador != null))
            {
                ...
                FacturaCompra instancia = new FacturaCompra();               
                Persistencia persistencia = new Persistencia();
                instancia = (FacturaCompra) persistencia.filtrarId(instancia, codigo);
                ...
                if (formatoJSON.trim().endsWith("null") ) {
                    ...
                    formatoJSON = "["+formatoJSON
                        +",{\"montoletras\":"+ "\""
                        +n.numeroaLetras(instancia.getMonto_total())+"\"}]"; 
                }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FacturaCompraJSON.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
