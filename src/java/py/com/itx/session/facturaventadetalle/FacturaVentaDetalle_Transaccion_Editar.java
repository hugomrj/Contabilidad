...
@WebServlet(name = "FacturaVentaDetalle_Transaccion_Editar",
        urlPatterns = {"/FacturaVentaDetalle/Transaccion/Editar"})


public class FacturaVentaDetalle_Transaccion_Editar extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FacturaVentaDetalle_Transaccion_Editar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
