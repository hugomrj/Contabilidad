...
@WebServlet(name = "FacturaVentaDetalle_Coleccion_Detalle", 
        urlPatterns = {"/FacturaVentaDetalle/Coleccion/Detalle"})


public class FacturaVentaDetalle_Coleccion_Detalle extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FacturaVentaDetalle_Coleccion_Detalle.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
