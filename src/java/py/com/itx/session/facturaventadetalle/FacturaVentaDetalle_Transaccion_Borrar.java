...
@WebServlet(name = "FacturaVentaDetalle_Transaccion_Borrar",
        urlPatterns = {"/FacturaVentaDetalle/Transaccion/Borrar"})


public class FacturaVentaDetalle_Transaccion_Borrar extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FacturaVentaDetalle_Transaccion_Borrar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
