...
@WebServlet(name = "FacturaVentaDetalleJSON", 
        urlPatterns = {"/FacturaVentaDetalle/Linea.json"})


public class FacturaVentaDetalleJSON extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {            
            ...
            {                
                ...
                instancia = (FacturaVentaDetalle) persistencia.filtrarId(instancia, codigo);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FacturaVentaDetalleJSON.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
