...
@WebServlet(name = "FacturaVentaDetalle_Transaccion_PieJSON",
        urlPatterns = {"/FacturaVentaDetalle/Transaccion/Pie.json"})


public class FacturaVentaDetalle_Transaccion_PieJSON extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FacturaVentaDetalle_Transaccion_PieJSON.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
