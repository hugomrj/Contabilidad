...
@WebServlet(name = "FacturaVentaDetalle_Transaccion_JSON",
        urlPatterns = {"/FacturaVentaDetalle/Transaccion/Linea.json"})


public class FacturaVentaDetalle_Transaccion_JSON extends HttpServlet {
...
*/
        ...
        {            
                ...
                instancia = transaccion.getVentaDetalleTransaccion( codigo );
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FacturaVentaDetalle_Transaccion_JSON.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
