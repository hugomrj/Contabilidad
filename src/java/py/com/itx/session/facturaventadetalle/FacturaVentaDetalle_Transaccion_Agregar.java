...
@WebServlet(name = "FacturaVentaDetalle_Transaccion_Agregar",
        urlPatterns = {"/FacturaVentaDetalle/Transaccion/Agregar"})


public class FacturaVentaDetalle_Transaccion_Agregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            instancia = (FacturaVentaDetalle) persistencia.extraerRegistro(request, instancia);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FacturaVentaDetalle_Transaccion_Agregar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
