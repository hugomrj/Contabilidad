...
@WebServlet(name = "FacturaVentaDetalle_Transaccion_Size",
        urlPatterns = {"/FacturaVentaDetalle/Transaccion/Size"})


public class FacturaVentaDetalle_Transaccion_Size extends HttpServlet {
...
*/
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FacturaVentaDetalle_Transaccion_Size.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
