...
@WebServlet(name = "FacturaVenta_Coleccion_Lista", 
        urlPatterns = {"/FacturaVenta/Coleccion/Lista"})


public class FacturaVenta_Coleccion_Lista extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
            ...
            List<Map<String, Object>> rows = dao.Lista(cliente, 
                    contador.getContador(), strBuscar, page);    

            request.setAttribute("lista", rows);            
            request.setAttribute("totalRegistros", dao.totalRegistros);
            
            request.getRequestDispatcher("/Session/FacturaVenta/jspf/basictable.jspx").include(request, response);                
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FacturaVenta_Coleccion_Lista.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
